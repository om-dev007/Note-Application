                  ...
                  <>
                    ...
                    <div className="flex gap-2 mt-4">
                      <button
                        ...
                        className="flex-1 bg-green-600 cursor-pointer hover:bg-green-500 py-2 rounded-lg text-sm"
                      >
                        Save
                      </button>
                      ...
                      <button
                        onClick={cancelEdit}
                        className="flex-1 bg-white/10 hover:bg-white/20 py-2 cursor-pointer rounded-lg text-sm"
                      >
                        Cancel
                      </button>
                    </div>
                  ...
                  <>
                    ...
                    <div className="mt-6 flex gap-2">
                      <button
                        ...
                        className="flex-1 bg-indigo-600 cursor-pointer hover:bg-indigo-500 py-2 rounded-lg text-sm"
                      >
                        Edit
                      </button>
